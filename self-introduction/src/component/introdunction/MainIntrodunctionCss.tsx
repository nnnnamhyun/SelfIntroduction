...
import Individual from "./Work/Individual";
  ...
  const SKILL_LIST: SkillItemProps[] = [
    ...
    },
    {
      ...
      descriptions: [
        ...
        "eslint/prettier를 통한 코드 협약을 중요시 여기고 이를 바탕으로 개발 할 수 있습니다.",
                ...
                <div className='profile'>
                  ...
                  <div className='name'>
                    ...
                    <Button
                      ...
                      target={"_blank"}
                      href={
                        "https://www.linkedin.com/in/%EB%82%A8%ED%98%84-%EA%B9%80-2a8644167"
                      }
                    >
                    ...
                    <h6 className='job'>
                      {" "}
                      성균관대학교 소프트웨어플랫폼학과 석사
                    </h6>
                    <h6 className='job'>
                      {" "}
                      티맥스소프트 미들웨어팀 연구원 ( 2018.02 ~ ing ){" "}
                    </h6>
                  </div>
                </div>
              </GridItem>
